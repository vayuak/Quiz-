...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        questions[0][0] = "Find the Incorrect option from Following .";
        questions[0][1] = "Multilevel Inheritance";
        questions[0][2] = "Single Inheritance";
        questions[0][3] = "Multiple Inheritance";
        questions[0][4] = "Hierarchical Inheritance";
        ...
        answers[0][1] = "Multiple Inheritance";
